/**
 * tail-skill - Display last lines of a file with validated flags
 */
...
// Note: -f is intentionally excluded as it blocks indefinitely
...
export async function action(agent, prompt) {
    ...
    const result = await executeWithPermission('tail', args, agent, { context });
